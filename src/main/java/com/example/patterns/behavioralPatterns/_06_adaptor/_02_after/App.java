...
import com.example.patterns.behavioralPatterns._06_adaptor._02_after.security.LoginHandler;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        UserDetailService userDetailsService = new AccountUserDetailsService(accountService);
