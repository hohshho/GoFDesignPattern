...
import com.example.patterns.behavioralPatterns._09_decorator._02_after.decorator.SpamFilteringCommentDecorator;
import com.example.patterns.behavioralPatterns._09_decorator._02_after.decorator.TrimmingCommentDecorator;

/**
 * 데코레이터 패턴을 사용해 상속이 아닌 위임으로 문제를 해결
 */
public class App {
